...
public class Test1015 {
    ...
    // 希尔排序 最好时间复杂度O(n) 最坏时间复杂度O(n^1.3) 不稳定
    ...
    // 冒泡排序 最好时间复杂度O(n) 最坏时间复杂度O(n^2) 稳定
    ...
    // 快速排序 最好时间复杂度O(n*log2n) 最坏时间复杂度O(n^2) 不稳定
